...
export default function Author() {
    ...
    return (
        <Box mb="60px">
            <Box position="relative" w="full" h="140px" bgColor="purple.400" mb="90px" >
                <Image src={`/${AUTHORDATA.authorImg}`} alt="الكاتب" 
                    rounded="full" 
                    w="170px" 
                    h="170px" 
                    position="absolute" right={{base: "15px", md:"25px", lg: "3%", xl: "10%"}} 
                    bottom="-75px"
                    border="8px solid"
                ...
                <Flex flexDir={{base:"column", lg:"row"}} mt="80px">
                    <Flex flexDir="column">
                        <Box mb="30px">
                            ...
                            <Text fontSize="18px" fontWeight="600">{AUTHORDATA.bio}</Text>
                        </Box>
                        <Flex mb="30px" w="full" justifyContent="space-between" alignItems="center">
                            <Heading fontSize="22px" color="brand.primary">المقالات</Heading>
                            <Menu>
