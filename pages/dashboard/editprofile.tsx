...
const EditProfile = () => {
    ...
    const [isWantUpdateFirstName, setIswantUpdateFirstName] = useState<boolean>(false);
    const [isUpdatingFirstName, setIsUpdatingFirstName] = useBoolean();

    // const [lastName, setLastName] = useState<string>("");
    const [isWantUpdateLastName, setIswantUpdateLastName] = useState<boolean>(false);
    const [isUpdatingLastName, setIsUpdatingLastName] = useBoolean();

    // const [username, setUsername] = useState<string | undefined>(undefined);
    const [isWantUpdateUsername, setIswantUpdateUsername] = useState<boolean>(false);
    ...
    const [isWantUpdateFacebookAccount, setIswantUpdateFacebookAccount] = useState<boolean>(false);
    const [isUpdatingFacebookAccount, setIsUpdatingFacebookAccount] = useBoolean();

    // const [instaAccount, setInstaAccount] = useState<string>("");
    const [isWantUpdateInstaAccount, setIswantUpdateInstaAccount] = useState<boolean>(false);
