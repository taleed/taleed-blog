    ...
    <>
      ...
      <Menu>
        <MenuButton
          ...
          px="20px"
          rightIcon={<BiChevronDownCircle color="#06D3F4" fontSize={"24px"} />}
        >
...
const Navbar = () => {
  ...
  return (
    <Box>
      ...
      >
        <Flex>
          <Flex w="full" h="70px" align="center">
          ...
          >
            ...
            <Flex flexDir="column" align="center" my="20px">
              ...
              <Box w="full" onClick={() => changeDisplay("none")}>
                <NavbarMobileLinksSec />
              </Box>
            </Flex>
          </Flex>
        </Flex>
          ...
          <Flex w="full" h="60px" justify="space-between" align="center">
            <NextLink href="/" passHref>
              ...
              >
                ...
                <Text mr="15px" fontSize="18px" letterSpacing="1px">
                  تليــد
                </Text>
              </Button>
            </NextLink>
            ...
            <InputGroup
              w={{ base: "48px", md: "320px", lg: "260px" }}
              _hover={{ width: { base: "220px", md: "320px", lg: "260px" } }}
              _focusWithin={{
                width: { base: "220px", md: "320px", lg: "260px" },
              }}
              transition="width"
            ...
            >
              ...
              <InputLeftElement w="48px">
                <Icon as={BiSearch} color="gray.600" fontSize="24px" />
              </InputLeftElement>
            </InputGroup>
          </Flex>
        </Flex>
